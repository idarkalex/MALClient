...
namespace MALClient.Android.Fragments
{
    public partial class AnimeDetailsPageFragment : MalFragmentBase
    {
        ...
        private void ShowVideoOverlay(string url)
        {
            ...
            AnimeDetailsPageVideoWebView.SetWebViewClient(new InlineVideoWebViewClient(AnimeDetailsPageVideoWebView));
            AnimeDetailsPageVideoOverlay.Visibility = ViewStates.Visible;
            AnimeDetailsPageVideoWebView.LoadUrl(url);
        }

        private class InlineVideoWebViewClient : WebViewClient
        {
            ...
            private static string ExtractYouTubeId(string url)
            {
                var match = System.Text.RegularExpressions.Regex.Match(
                    url, @"(?:vnd\.youtube:|v=|/embed/|youtu\.be/)([A-Za-z0-9_\-]{6,})");
